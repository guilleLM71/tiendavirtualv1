...
function AdminRegistrarProductos(props) {
  ...
  useEffect(() => {
   ...
   const submitHandler = async (e) => {
       ...
       try {
         ...
         await axios.post(
           `http://localhost:4000/api/productos/nuevoproducto`,
           {
  ...
  return (
    ...
    <ThemeProvider theme={theme}>
      ...
      <Typography alignItems={'center'} fontSize={30}
        ...
        >Registrar Productos</Typography>
        <CssBaseline />
...
export default AdminRegistrarProductos;